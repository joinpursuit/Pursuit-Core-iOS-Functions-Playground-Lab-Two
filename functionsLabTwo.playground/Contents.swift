...
let testCasesOne: [([Double], Double)] = [
    ...
    (input: [1,42,1,541,42,5], expectedOutput: 105), //expectedOutput is 105.3333333
...
let testCasesFour = [
    ...
    (inputOne: 105.1, inputTwo: [1,42,1,541,42,5], expectedOutput: true), // expectedOutput: false
]
...
// Your function here
func secondSmallestValue(in: [Int]) -> Int {
    let sorted = `in`.sorted()
    return sorted[1]
}
